...
class HMC():
    ...
    def leapfrog_Vgq(self, q, p, N, step_size, V_q=None, V_gq=None):
        ...
        try:
            ...
            print("exception leapfrog_Vgq: ", e)
    ...
    def sample(self, q, step_size = 0.01, nsamples=20, burnin=10, nleap=30, p=None, callback=None, skipburn=True, epsadapt=0, verbose = False):
